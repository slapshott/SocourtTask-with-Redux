...
function editBookAction(name, author, genre, creationDate, lastUpdate, id){
    return async (dispatch) => {
        try{
            let data = await editBook(name, author, genre, creationDate, lastUpdate, id)
            dispatch(editBookSucces(data))
        }catch(error){
            dispatch({
                type: AJAX_ERROR,
                error
